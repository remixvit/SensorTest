// ======================================================================
// SensorTest.v generated from TopDesign.cysch
// 02/01/2016 at 02:04
...
`ifdef WARP
`define CY_BLK_DIR "C:\My Programs\PSoC\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\ZeroTerminal"
`include "C:\My Programs\PSoC\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\ZeroTerminal\ZeroTerminal.v"
`else
`define CY_BLK_DIR "C:\My Programs\PSoC\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\ZeroTerminal"
`include "C:\My Programs\PSoC\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\ZeroTerminal\ZeroTerminal.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "C:\My Programs\PSoC\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\or_v1_0"
`include "C:\My Programs\PSoC\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\or_v1_0\or_v1_0.v"
`else
`define CY_BLK_DIR "C:\My Programs\PSoC\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\or_v1_0"
`include "C:\My Programs\PSoC\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\or_v1_0\or_v1_0.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "C:\My Programs\PSoC\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_analog_virtualmux_v1_0"
`include "C:\My Programs\PSoC\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_analog_virtualmux_v1_0\cy_analog_virtualmux_v1_0.v"
`else
`define CY_BLK_DIR "C:\My Programs\PSoC\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_analog_virtualmux_v1_0"
`include "C:\My Programs\PSoC\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_analog_virtualmux_v1_0\cy_analog_virtualmux_v1_0.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "C:\My Programs\PSoC\PSoC Creator\3.3\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\Bus_Connect_v2_20"
`include "C:\My Programs\PSoC\PSoC Creator\3.3\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\Bus_Connect_v2_20\Bus_Connect_v2_20.v"
`else
`define CY_BLK_DIR "C:\My Programs\PSoC\PSoC Creator\3.3\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\Bus_Connect_v2_20"
`include "C:\My Programs\PSoC\PSoC Creator\3.3\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\Bus_Connect_v2_20\Bus_Connect_v2_20.v"
`endif
...
module ADC_SAR_SEQ_P4_v2_20_0 (
	...
	cy_clock_v1_0
		#(.id("c0127f0c-5a76-4e55-b389-bb6821ca1e87/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
...
module SCB_P4_v3_0_1 (
	...
	cy_clock_v1_0
		#(.id("15faafef-6f0c-4414-bb40-1c8d47086dfb/2dc2d7a8-ce2b-43c7-af4a-821c8cd73ccf"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("156250000"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("15faafef-6f0c-4414-bb40-1c8d47086dfb/5382e105-1382-4a2e-b9f4-3bb2feba71e0"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("15faafef-6f0c-4414-bb40-1c8d47086dfb/22863ebe-a37b-476f-b252-6e49a8c00b12"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
...
`ifdef WARP
`define CY_BLK_DIR "C:\My Programs\PSoC\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\CyStatusReg_v1_90"
`include "C:\My Programs\PSoC\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\CyStatusReg_v1_90\CyStatusReg_v1_90.v"
`else
`define CY_BLK_DIR "C:\My Programs\PSoC\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\CyStatusReg_v1_90"
`include "C:\My Programs\PSoC\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\CyStatusReg_v1_90\CyStatusReg_v1_90.v"
`endif
...
module top ;
    ...
    CyStatusReg_v1_90 Charge_Status_Reg (
        .status_0(Net_365),
        .status_1(Net_366),
        .status_2(1'b0),
        .status_3(1'b0),
        ...
        .intr(Net_374),
        .status_bus(8'b0));
    defparam Charge_Status_Reg.Bit0Mode = 0;
    defparam Charge_Status_Reg.Bit1Mode = 0;
    defparam Charge_Status_Reg.Bit2Mode = 0;
    defparam Charge_Status_Reg.Bit3Mode = 0;
    defparam Charge_Status_Reg.Bit4Mode = 0;
    defparam Charge_Status_Reg.Bit5Mode = 0;
    defparam Charge_Status_Reg.Bit6Mode = 0;
    defparam Charge_Status_Reg.Bit7Mode = 0;
    defparam Charge_Status_Reg.BusDisplay = 0;
    defparam Charge_Status_Reg.Interrupt = 0;
    defparam Charge_Status_Reg.MaskValue = 0;
    defparam Charge_Status_Reg.NumInputs = 2;

	wire [0:0] tmpOE__Bat_ADC_net;
	wire [0:0] tmpFB_0__Bat_ADC_net;
	wire [0:0] tmpIO_0__Bat_ADC_net;
	wire [0:0] tmpINTERRUPT_0__Bat_ADC_net;
	electrical [0:0] tmpSIOVREF__Bat_ADC_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		Bat_ADC
		 (.oe(tmpOE__Bat_ADC_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Bat_ADC_net[0:0]}),
		  .analog({Net_97}),
		  .io({tmpIO_0__Bat_ADC_net[0:0]}),
		  .siovref(tmpSIOVREF__Bat_ADC_net),
		  .interrupt({tmpINTERRUPT_0__Bat_ADC_net[0:0]}),
		  .annotation({Net_658}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Bat_ADC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Charge_PG_net;
	wire [0:0] tmpFB_0__Charge_PG_net;
	wire [0:0] tmpIO_0__Charge_PG_net;
	wire [0:0] tmpINTERRUPT_0__Charge_PG_net;
	electrical [0:0] tmpSIOVREF__Charge_PG_net;

	cy_psoc3_pins_v1_10
		#(.id("5b1fa675-4dd9-453c-836b-55b48c20e8d8"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Charge_PG
		 (.oe(tmpOE__Charge_PG_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Charge_PG_net[0:0]}),
		  .io({tmpIO_0__Charge_PG_net[0:0]}),
		  .siovref(tmpSIOVREF__Charge_PG_net),
		  .interrupt({tmpINTERRUPT_0__Charge_PG_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Charge_PG_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Charge_ST1_net;
	wire [0:0] tmpIO_0__Charge_ST1_net;
	wire [0:0] tmpINTERRUPT_0__Charge_ST1_net;
	electrical [0:0] tmpSIOVREF__Charge_ST1_net;

	cy_psoc3_pins_v1_10
		#(.id("ec8b5bed-a617-4b25-ac08-19855d66d276"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Charge_ST1
		 (.oe(tmpOE__Charge_ST1_net),
		  .y({1'b0}),
		  .fb({Net_365}),
		  .io({tmpIO_0__Charge_ST1_net[0:0]}),
		  .siovref(tmpSIOVREF__Charge_ST1_net),
		  .interrupt({tmpINTERRUPT_0__Charge_ST1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Charge_ST1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Charge_ST2_net;
	wire [0:0] tmpIO_0__Charge_ST2_net;
	wire [0:0] tmpINTERRUPT_0__Charge_ST2_net;
	electrical [0:0] tmpSIOVREF__Charge_ST2_net;

	cy_psoc3_pins_v1_10
		#(.id("93a3b31e-589a-4520-a6b1-a7ae93942b25"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Charge_ST2
		 (.oe(tmpOE__Charge_ST2_net),
		  .y({1'b0}),
		  .fb({Net_366}),
		  .io({tmpIO_0__Charge_ST2_net[0:0]}),
		  .siovref(tmpSIOVREF__Charge_ST2_net),
		  .interrupt({tmpINTERRUPT_0__Charge_ST2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Charge_ST2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("783ecf93-5349-4cc5-aa4d-3d05bad5c0dc"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__Clk_1_net;
	wire [0:0] tmpFB_0__Clk_1_net;
	wire [0:0] tmpIO_0__Clk_1_net;
	wire [0:0] tmpINTERRUPT_0__Clk_1_net;
	electrical [0:0] tmpSIOVREF__Clk_1_net;
	...
	cy_psoc3_pins_v1_10
		...
		Clk_1
		 (.oe(tmpOE__Clk_1_net),
		  .y({Net_510}),
		  .fb({tmpFB_0__Clk_1_net[0:0]}),
		  .io({tmpIO_0__Clk_1_net[0:0]}),
		  .siovref(tmpSIOVREF__Clk_1_net),
		  .interrupt({tmpINTERRUPT_0__Clk_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Clk_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Clk_2_net;
	wire [0:0] tmpFB_0__Clk_2_net;
	wire [0:0] tmpIO_0__Clk_2_net;
	wire [0:0] tmpINTERRUPT_0__Clk_2_net;
	electrical [0:0] tmpSIOVREF__Clk_2_net;

	cy_psoc3_pins_v1_10
		#(.id("76224b08-d7d2-4b9a-a79e-22c35c01bec2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		Clk_2
		 (.oe(tmpOE__Clk_2_net),
		  .y({Net_516}),
		  .fb({tmpFB_0__Clk_2_net[0:0]}),
		  .io({tmpIO_0__Clk_2_net[0:0]}),
		  .siovref(tmpSIOVREF__Clk_2_net),
		  .interrupt({tmpINTERRUPT_0__Clk_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Clk_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("7622b503-9159-4bd6-837b-afad197f4d8f"),
	...
	cy_clock_v1_0
		#(.id("0d09651d-d8a6-4bbe-b500-8a118c1f5cc0"),
	...
	wire [0:0] tmpOE__DisplayReset_net;
	wire [0:0] tmpFB_0__DisplayReset_net;
	wire [0:0] tmpIO_0__DisplayReset_net;
	wire [0:0] tmpINTERRUPT_0__DisplayReset_net;
	electrical [0:0] tmpSIOVREF__DisplayReset_net;

	cy_psoc3_pins_v1_10
		#(.id("12fdeb79-25b5-498f-b92e-7994f22fd055"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		DisplayReset
		 (.oe(tmpOE__DisplayReset_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DisplayReset_net[0:0]}),
		  .io({tmpIO_0__DisplayReset_net[0:0]}),
		  .siovref(tmpSIOVREF__DisplayReset_net),
		  .interrupt({tmpINTERRUPT_0__DisplayReset_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DisplayReset_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("0f2ff3b0-c0b0-41cd-b898-0ec69567fa2d"),
		  .source_clock_id(""),
		  .divisor(0),
